...
share* BuildHMACSHA1Circuit(share* s_msgSi, share* s_msgSo, share* s_msgC, uint8_t* msgSi, uint8_t* msgSo, uint8_t* msgC, uint8_t* int_out, uint32_t nvals, BooleanCircuit* circ);
